...
export const guideIndex: GuideIndexEntry[] = [
  ...
  },
  {
    ...
    cluster: 'Tools',
    title: 'Zoho Invoice Alternative: When You Need an Account and When You Do Not',
    summary: 'Where a hosted invoicing account is the right answer, where a browser-only generator is, and how to tell which you need.',
  },
  {
    slug: 'wave-invoicing-alternative',
    cluster: 'Tools',
    title: 'Wave Invoicing Alternative: Bundled Accounting or Just the Document',
    summary: 'Wave bundles invoicing with accounting and payments. What that gets you, what it costs you, and when you need none of it.',
  },
  {
    slug: 'vat-calculator',
    cluster: 'Calculators',
...
export const guideLoaders: Record<string, () => Promise<GuideConfig>> = {
  ...
  'zoho-invoice-alternative': () => import('./comparisons').then((m) => m.zohoInvoiceAlternativeGuide),
  'wave-invoicing-alternative': () => import('./comparisons').then((m) => m.waveInvoicingAlternativeGuide),
...
export const guideModulePath: Record<string, string> = {
  ...
  'zoho-invoice-alternative': 'src/pages/guides/comparisons.ts',
  'wave-invoicing-alternative': 'src/pages/guides/comparisons.ts',
